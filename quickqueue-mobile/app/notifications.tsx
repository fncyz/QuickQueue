...
const s = StyleSheet.create({
  safe: { backgroundColor: '#0842A7', flex: 1 }, header: { alignItems: 'center', backgroundColor: '#0842A7', flexDirection: 'row', height: 82, justifyContent: 'space-between', paddingHorizontal: 14 }, back: { backgroundColor: '#073B96', borderRadius: 3, padding: 7 }, title: { color: '#FFFFFF', fontSize: 21, fontWeight: '800' }, headerSpace: { width: 41 }, page: { backgroundColor: '#FFFFFF', borderTopLeftRadius: 24, borderTopRightRadius: 24, flex: 1 }, content: { paddingBottom: 20, paddingTop: 14 }, filterScroller: { flexGrow: 0, height: 45, maxHeight: 45 }, filters: { alignItems: 'center', gap: 7, paddingHorizontal: 16, paddingVertical: 4 }, filter: { alignItems: 'center', backgroundColor: '#F0F6FF', borderRadius: 18, flexDirection: 'row', gap: 5, height: 36, justifyContent: 'center', paddingHorizontal: 8, width: 128 }, filterActive: { backgroundColor: '#0750B9' }, filterText: { color: '#17447F', fontSize: 11, fontWeight: '700' }, filterTextActive: { color: '#FFFFFF' }, count: { alignItems: 'center', backgroundColor: '#1580FF', borderRadius: 9, height: 18, justifyContent: 'center', minWidth: 18, paddingHorizontal: 4 }, countActive: { backgroundColor: '#FFFFFF' }, countText: { color: '#FFFFFF', fontSize: 9, fontWeight: '800' }, countTextActive: { color: '#0750B9' }, group: { paddingHorizontal: 16, paddingTop: 18 }, groupHeader: { alignItems: 'center', flexDirection: 'row', marginBottom: 10 }, groupTitle: { color: '#082E73', fontSize: 14, fontWeight: '800' }, unreadPill: { backgroundColor: '#E8F3FF', borderRadius: 11, marginLeft: 'auto', paddingHorizontal: 9, paddingVertical: 5 }, unreadPillText: { color: '#0873FF', fontSize: 9, fontWeight: '700' }, markAllButton: { marginLeft: 12 }, markAll: { color: '#0750B9', fontSize: 9, fontWeight: '700' }, loading: { alignItems: 'center', backgroundColor: '#FFFFFF', flex: 1, justifyContent: 'center' }, card: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#DFE8F5', borderRadius: 10, borderWidth: StyleSheet.hairlineWidth, flexDirection: 'row', gap: 11, marginBottom: 8, minHeight: 68, padding: 10 }, unread: { backgroundColor: '#EDF6FF', borderColor: '#DCEBFA' }, icon: { alignItems: 'center', borderRadius: 20, height: 40, justifyContent: 'center', width: 40 }, copy: { flex: 1 }, row: { alignItems: 'center', flexDirection: 'row', gap: 7 }, cardTitle: { color: '#0D347B', flex: 1, fontSize: 12, fontWeight: '800' }, dot: { backgroundColor: '#0873FF', borderRadius: 3, height: 6, width: 6 }, message: { color: '#55709B', fontSize: 10, lineHeight: 14, marginTop: 3 }, date: { color: '#6683AF', fontSize: 9 }, empty: { alignItems: 'center', paddingHorizontal: 28, paddingTop: 100 }, emptyTitle: { color: '#19345F', fontSize: 17, fontWeight: '800', marginTop: 14 }, emptyText: { color: '#76839A', fontSize: 12, marginTop: 6, textAlign: 'center' },
});
