...
export default function ProfileScreen() {
  ...
  return <SafeAreaView style={s.safe} edges={['top']}>
    <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
      <View style={s.hero}><Pressable onPress={() => router.back()} style={s.back}><Ionicons name="chevron-back" size={27} color="#FFF" /></Pressable><Text style={s.heading}>My Profile</Text><Text style={s.subheading}>View and manage your personal information.</Text></View>
      <View style={s.body}>
