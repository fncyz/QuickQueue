...
export default function PersonalInformationScreen() {
  ...
  return <SafeAreaView style={[s.safe, { backgroundColor: colors.background }]} edges={['top']}><ScrollView contentContainerStyle={[s.content, { backgroundColor: colors.background }]} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
    <View style={[s.hero, { backgroundColor: colors.primary }]}><Pressable onPress={() => router.back()} style={s.back}><Ionicons name="chevron-back" size={27} color="#FFFFFF" /></Pressable><Text style={s.heading}>Edit Personal Information</Text><Text style={s.subheading}>Update your details and profile picture.</Text></View>
